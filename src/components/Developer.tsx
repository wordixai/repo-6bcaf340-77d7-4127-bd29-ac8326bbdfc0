...
const tabs = ["OpenAI", "Google Gemini", "Anthropic Claude"];
            ...
            <div className="flex space-x-4 mb-4">
              {tabs.map((tab, index) => (
                <Button
                  ...
                  className={
                    index === activeTab
                      ? "px-4 py-2 rounded-lg border transition-all bg-white text-black border-white"
                      : "px-4 py-2 rounded-lg border transition-all text-zinc-300 border-zinc-600 hover:border-zinc-400"
                  }
                  variant="outline"
                >
                  {tab}
