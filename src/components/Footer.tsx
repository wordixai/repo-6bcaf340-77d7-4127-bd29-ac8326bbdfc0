export function Footer() {
  return (
    <footer id="contact" className="py-16 px-4 sm:px-6 lg:px-8 border-t border-secondary">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-secondary mt-8 pt-8 text-center text-zinc-400">
